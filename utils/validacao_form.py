def verifica_campos(nome, email, telefone, pais, cep, estado, cidade, bairro, logradouro, numero, complemento, **kwargs):
    ...
    if not nome or not email or not telefone or not pais or not cep or not estado or not cidade or not bairro or not logradouro or not numero or not complemento or not verif_campos_dinamicos():
